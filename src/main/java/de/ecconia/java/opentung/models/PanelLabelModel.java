...
public class PanelLabelModel extends GenericModel
{
	public PanelLabelModel()
	{
		//Create:
		IntHolder offset = new IntHolder(); //Vertices array offset
		vertices = new float[6 * 4 * 9 - 1 * 4 * 9];
		placeCube(0, 0.05f + 0.075f, 0, 0.15f, 0.05f, 0.15f, 1.0f, 1.0f, 1.0f, offset, Direction.yP); //Base
