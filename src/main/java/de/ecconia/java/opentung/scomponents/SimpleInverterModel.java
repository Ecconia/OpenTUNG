...
public class SimpleInverterModel extends SComponent
{
	...
	public SimpleInverterModel()
	{
		...
		placeCube(0, 0.15f + 0.12f, 0, 0.045f, 0.12f, 0.045f, 0.0f, 0.0f, 0.0f, offset, Direction.yN); //Input
		placeCube(0, 0, 0.15f + 0.06f, 0.075f, 0.075f, 0.06f, 1.0f, 0.0f, 0.0f, offset, Direction.zN); //Output Direction.xP
		...
		placeCubeIndices(offset, 2 * 24 - 4, Direction.zN); //Output Direction.xP
