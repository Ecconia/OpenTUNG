...
public class DynamicBoardVAO extends GenericVAO
{
	...
	protected void init()
	{
		...
		//Texture
		GL30.glVertexAttribPointer(2, 2, GL30.GL_FLOAT, false, 9 * Float.BYTES, 6 * Float.BYTES);
		GL30.glEnableVertexAttribArray(2);
		//Flag isNotSide
		GL30.glVertexAttribPointer(3, 1, GL30.GL_FLOAT, false, 9 * Float.BYTES, 8 * Float.BYTES);
